...
public class s_TCP : MonoBehaviour
{
    ...
    public String Host = "192.168.2.185";
    ...
    private void scoreCalculation()
    {
        ...
        if (listWaitTrigger[0].Count <= samplingFreq * 4)
        {
            ...
            listWaitTrigger[0].Add(lastSignal.signalMatrix[0, 0]);
            listWaitTrigger[1].Add(lastSignal.signalMatrix[0, 1]);
            listWaitTrigger[2].Add(lastSignal.signalMatrix[0, 2]);
            listWaitTrigger[3].Add(lastSignal.signalMatrix[0, 3]);
            listWaitTrigger[4].Add(lastSignal.signalMatrix[0, 4]);
            listWaitTrigger[5].Add(lastSignal.signalMatrix[0, 5]);
        }
